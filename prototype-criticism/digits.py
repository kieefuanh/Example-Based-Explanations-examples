...
cwd = '../artifacts/prototype-criticism/'
data_dir = cwd + 'data/'
...
if num_prototypes > 0:
    ...
    if make_plots:
        ...
        plt.savefig(output_dir + f'{num_prototypes}_prototypes_digits.png')
        print('Done.', flush=True)
    ...
    if num_criticisms > 0:
        ...
        if make_plots:
            ...
            plt.savefig(output_dir + f'{num_criticisms}_criticisms_digits.png')
            print('Done.', flush=True)
